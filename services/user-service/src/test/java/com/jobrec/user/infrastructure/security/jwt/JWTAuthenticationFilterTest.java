...
class JWTAuthenticationFilterTest {
    ...
    private com.jobrec.user.infrastructure.security.jwt.JWTAuthenticationFilter filter;
    private MockedStatic<SecurityContextHolder> mockedSch;
    private SecurityContext securityContext;

    @BeforeEach
    void setUp() {
        jwtUtil = mock(com.jobrec.user.infrastructure.security.jwt.JWTUtil.class);
        filter = new com.jobrec.user.infrastructure.security.jwt.JWTAuthenticationFilter(jwtUtil);

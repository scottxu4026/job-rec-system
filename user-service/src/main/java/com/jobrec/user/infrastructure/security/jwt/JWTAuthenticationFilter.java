...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(@NonNull HttpServletRequest request,
		...
		try {
			...
			AuthPrincipal principal = new AuthPrincipal(userId, username, claims.get("email", String.class), role);
			...
			try {
				...
				if (writer != null) {
					writer.write("{\\\"status\\\":\\\"error\\\",\\\"message\\\":\\\"Token expired\\\"}");
					writer.flush();
				}
			} catch (Exception ignored) { }
			...
			try {
				...
				java.io.PrintWriter writer = response.getWriter();
				if (writer != null) {
					writer.write("{\\\"status\\\":\\\"error\\\",\\\"message\\\":\\\"Invalid token signature\\\"}");
					writer.flush();
				}
			} catch (Exception ignored) { }
			SecurityContextHolder.clearContext();
			...
			try {
				...
				java.io.PrintWriter writer = response.getWriter();
				if (writer != null) {
					writer.write("{\\\"status\\\":\\\"error\\\",\\\"message\\\":\\\"Malformed token\\\"}");
					writer.flush();
				}
			} catch (Exception ignored) { }
			SecurityContextHolder.clearContext();
			...
			try {
				...
				java.io.PrintWriter writer = response.getWriter();
				if (writer != null) {
					writer.write("{\\\"status\\\":\\\"error\\\",\\\"message\\\":\\\"Missing or blank token\\\"}");
					writer.flush();
				}
			} catch (Exception ignored) { }
			SecurityContextHolder.clearContext();
			...
			try {
				...
				java.io.PrintWriter writer = response.getWriter();
				if (writer != null) {
					writer.write("{\\\"status\\\":\\\"error\\\",\\\"message\\\":\\\"Invalid token\\\"}");
					writer.flush();
				}
			} catch (Exception ignored) { }
			SecurityContextHolder.clearContext();
